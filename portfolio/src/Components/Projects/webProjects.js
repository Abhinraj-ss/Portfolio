export const webProjects =[
    {
        ...
        'link': 'https://percentpoll-2.herokuapp.com/'
    },
    {
        'title':'PercentPoll',
        'keywords':<b>Flask| Django| CSS| Python| Bootstrap| SQLite| SQLAlchemy| Git</b>,
        'content':" An anonymous, multi-page  poll app using Django and Flask. Hosts can create polls and share their poll links through various social platforms.",
